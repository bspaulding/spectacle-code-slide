...
var CodeSlide = function (_React$Component) {
  ...
  _createClass(CodeSlide, [{
    ...
    value: function render() {
      ...
      var showLineNumbers = _props2.showLineNumbers;

      var rest = _objectWithoutProperties(_props2, ['code', 'lang', 'ranges', 'color', 'bgColor', 'notes', 'showLineNumbers']);

      var active = this.state.active;


      var range = ranges[active] || {};
      var locs = range.locs || range.loc && [range.loc] || [[]];
      var slideBg = bgColor || this.context.styles.global.body.background || defaultBgColor;
      ...
      var lines = getHighlightedCodeLines(code, lang).map(function (line, index) {
        return React.createElement('div', {
          ...
          dangerouslySetInnerHTML: {
            __html: showLineNumbers ? getLineNumber(index) + line : line ? line : '<span>&nbsp;</span>'
          },
